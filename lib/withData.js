...
const parseCookies = (context = {}) => (
  process.browser ? (
    ...
    context.req ? cookie.parse(context.req.headers.cookie) : {}
  )
)

const getToken = (context) => {
  const cookie = parseCookies(context)
  return cookie.token || (context && context.res.locals.token)
}
  ...
  class WithData extends React.Component {
    ...
    static async getInitialProps(context) {
      ...
      const routeParams = {
        ...
        registrationId: context.query.registrationId,
        userId: context.query.userId,
        eventId: context.query.eventId,
        mailingId: context.query.mailingId,
        ...
        try {
          ...
          const app = (
            <ApolloProvider client={apollo}>
              <ComposedComponent url={url} {...routeParams} {...composedInitialProps} />
            </ApolloProvider>
          )
    ...
    constructor(props) {
      ...
      this.apollo = initApollo(this.props.serverState, { getToken })
    }
